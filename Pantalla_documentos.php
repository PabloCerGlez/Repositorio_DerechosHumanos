...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <h1 style=" margin-top:20px; float:left;   margin-bottom:25px; color:      #FBD011
; ">Informacion</h1> 
<select style="  width : 600px;  margin-bottom:50px;  "  cols="10" class="form-control " id="control1" name="control1"> 
      ...
      <div class="col-6"  style="background-color:#262626; color:  #FFF;">
...
<!-- ...........................-->
 ...
 <main role="main" class="container-fluid">
      ...
      <table class="table" style="color:  #FFF; ">
        <thead class="thead" style="background-color:  #0E5EA8; ">
          <tr>
