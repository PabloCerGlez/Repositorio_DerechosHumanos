...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="nav_position">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup"  >
    ...
    <a class="nav-item nav-link btn btn-light " href="Pantalla_inicio.php">Inicio</a>
      <a class="nav-item nav-link active btn-light " style=" border-radius:5px; " href="#">Documentos <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link btn btn-light" href="Pantalla_agregar_archivos.php">Agregar</a>
    </div>
  </div>
</nav>
